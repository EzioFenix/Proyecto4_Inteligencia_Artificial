...
pandoc -V lang=es --to=beamer --pdf-engine=lualatex  --standalone formato.yaml --output=Diapositivas/diapositivas.tex README.md
pandoc -V lang=es --to=beamer --pdf-engine=lualatex formato.yaml --output=Diapositivas/diapositivas.pdf README.md
